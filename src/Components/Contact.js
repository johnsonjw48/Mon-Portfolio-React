      ...
      <section id="contact">
         ...
         <div className="row section-head">
            ...
            <div className="ten columns">
                  ...
                  <br/>
                  <p className="lead warning">Le formulaire de contact n'est pas encore configuré, merci de me contacter par e-mail ou téléphone pour le moment.</p>
